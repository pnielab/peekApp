  ...
  dataset: [
    {
      ...
      data: [
        {
          value:
            "2400,2000,2500,2800,3500,4000, 3700, 3750, 3880, 5000,5500,7500,8000,8200, 8400, 8500, 8550, 8800, 8700, 9000, 14000"
        },
        {
    ...
    },
    {
      ...
      data: [
        {
          value:
            "1900,2100,2300,2350,2400,2550,3000,3500,4000, 6000, 6500, 9000"
        },
        {
